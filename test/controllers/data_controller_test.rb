...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { date: @datum.date, destination: @datum.destination, flightnum: @datum.flightnum, origin: @datum.origin, plane: @datum.plane } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { date: @datum.date, destination: @datum.destination, flightnum: @datum.flightnum, origin: @datum.origin, plane: @datum.plane } }
