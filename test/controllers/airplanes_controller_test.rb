...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { colomn: @airplane.colomn, name: @airplane.name, row: @airplane.row } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { colomn: @airplane.colomn, name: @airplane.name, row: @airplane.row } }
